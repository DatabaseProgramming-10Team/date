...
<div class="popup_add_date">
    <h4>일정</h4>
    <form class="add_date" action="date/create_process" method="post">
      <fieldset class="name">
        <div class="color_box">
  ...
  <div class="popup_add_date update">
    <h4>일정 수정</h4>
    <form class="add_date" action="date/update_process" method="post">
      <fieldset class="name">
        <div class="color_box">
 <input type="radio" id="color1" name="color" value="color1" checked>
          <label for="color1" class="color1" ></label>
      ...
      <fieldset class="day">
        ...
        <label for="thu">목</label>
        <input type="checkbox" id="fri" name="금">
        <label for="fri">금</label> <input type="checkbox" id="sat" name="토">
        <label for="sat">토</label>
        <input type="checkbox" id="sun" name="일">
        <label for="sun">일</label>
      </fieldset>
